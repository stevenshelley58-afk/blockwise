        ...
        headers: [
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' https://accounts.google.com/gsi/client https://challenges.cloudflare.com https://www.googletagmanager.com https://www.clarity.ms https://va.vercel-scripts.com https://static.cloudflareinsights.com",
              "style-src 'self' 'unsafe-inline' https://accounts.google.com/gsi/style",
              "img-src " + imgSrc,
              "media-src " + mediaSrc,
              "font-src 'self' data:",
              `connect-src ${connectSrc}`,
              "frame-src 'self' https://accounts.google.com/gsi/ https://content-accounts.google.com https://challenges.cloudflare.com",
          ...
          // Google Identity Services opens a popup when FedCM is unavailable.
          // Plain same-origin severs it (see Google's setup guide), and the
          // public edge injects same-origin, so state ours explicitly.
