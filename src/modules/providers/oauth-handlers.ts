...
import type { MonitorProvider } from "@/modules/monitor/dashboard-data";
import { fetchGoogleAccessibleCustomers } from "@/modules/providers/google-reporting";
import { fetchMetaAdAccounts } from "@/modules/providers/meta-reporting";
