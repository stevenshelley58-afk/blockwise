...
export const blockwise: NicheConfig = {
  ...
  nav: {
    items: [
      { href: "/ad-studio", label: "Home", icon: "home", mobileLabel: "Home" },
      { href: "/ad-builder", label: "Ad Builder", icon: "studio", mobileLabel: "Ads" },
      { href: "/performance", label: "Performance", icon: "performance", mobileLabel: "Performance" },
      ...
      { href: "/ad-builder/brand", label: "Brand Pack", icon: "brand", section: "Set up" },
