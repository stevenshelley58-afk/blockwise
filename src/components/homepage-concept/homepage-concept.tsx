...
export function HomepageConcept() {
  return (
    <div className="hc-root">
      ...
      <main>
        <section className="hc-hero" id="top"><div className="hc-shell hc-hero-grid"><div className="hc-hero-copy"><h1><span>More leads.</span><span className="hc-hero-prompt">Less ad management.</span></h1><p>Blockwise helps real estate agents create, review and run Facebook and Instagram ads in one place.</p><div className="hc-hero-actions"><TrialLink className="max-[600px]:w-full">{TRIAL_CTA_LABEL}</TrialLink><span><Check aria-hidden="true" size={16} /> No card to create or download.</span></div></div><div className="hc-hero-visual"><HeroAdShowcase /></div></div></section>
