    ...
    <main className="bs-screen" aria-label="Brand Studio">
      ...
      <div className="bs-scroll">
        ...
        <div className="bs-logo-proof">
          ...
          <div className="lp">
            <div className="face" style={{ background: "#10141c", color: "#fff" }}>
              {initial}★ {brandName.split(" ")[0]?.toLowerCase()}
            </div>
            <small>
              <b>Dark</b>
...
const BRAND_STYLES = `
.bs-screen{position:fixed;inset:0;z-index:100;display:flex;flex-direction:column;background:#f7f8fa;color:var(--ink);font-size:14px}
...
.bs-screen .chip.good{background:#e8f6ef;color:#0e7a4d}
.bs-screen .chip.warn{background:#fdf4dd;color:#9a6b00}
...
.bs-top .notice.ok{color:#0e7a4d}
.bs-top .notice.err{color:#b91c1c}
.bs-scroll{flex:1;min-height:0;overflow:auto}
.bs-hero{background:linear-gradient(170deg,#10141c 0%,#15233a 90%);color:#fff;padding:30px 28px 78px}
.bs-hero .kick{font-size:11px;font-weight:700;letter-spacing:1.4px;text-transform:uppercase;color:#7e98c4}
...
.bs-hero h2 input:focus{border-bottom-color:#6ee7b0}
.bs-hero .scanline{margin-top:18px;display:flex;gap:9px;max-width:560px}
.bs-hero .url{flex:1;height:42px;border-radius:10px;background:rgba(255,255,255,.07);border:1px solid rgba(255,255,255,.12);display:flex;align-items:center;gap:10px;padding:0 14px;color:#dfe6f2;font-size:13.5px}
.bs-hero .url svg{color:#7e98c4;flex:0 0 auto}
.bs-hero .url input{flex:1;background:transparent;border:0;outline:0;color:#dfe6f2;min-width:0}
...
.bs-logo-proof .face.photo{background:linear-gradient(160deg,#3d5d80,#15233a);color:#fff;text-shadow:0 2px 10px rgba(0,0,0,.4)}
...
.bs-logo-proof small em{font-style:normal;color:var(--faint,#8a93a6)}
...
.bs-swatch small{font-size:10.5px;color:var(--faint,#8a93a6);letter-spacing:.4px}
...
.bs-picker .from-site small{font-size:10.5px;font-weight:700;letter-spacing:.6px;text-transform:uppercase;color:var(--faint,#8a93a6)}
...
.bs-spec small{display:block;color:var(--faint,#8a93a6);font-size:11px;text-transform:uppercase;letter-spacing:.6px;font-weight:700;margin-bottom:3px}
...
.bs-card .f>label small{color:var(--faint,#8a93a6);font-weight:550;font-size:11.5px}
...
.bs-tagrow span.no{background:#fdecec;color:#b91c1c}
...
.bs-disc textarea{font-size:12.5px;line-height:1.5;color:var(--muted);background:#f7f8fa;border-radius:9px;padding:10px 12px;border:0;outline:0;resize:none;width:100%}
.bs-disc textarea:focus{outline:2px solid var(--accent-tint)}
.bs-disc .add{border:1.5px dashed var(--line);color:var(--faint,#8a93a6);border-radius:9px;padding:9px;font-size:12px;font-weight:600;background:transparent}
.bs-rail{display:grid;gap:14px;align-content:start;position:sticky;top:20px;height:max-content}
.bs-rail .rail-stage{background:#10141c;border-radius:14px;padding:18px 16px;display:grid;gap:12px;justify-items:center}
.bs-rail .lbl{color:#8d96a8;font-size:11px;font-weight:700;letter-spacing:.8px;text-transform:uppercase}
.bs-rail .minis{display:flex;gap:12px}
.bs-rail .mini-story{width:126px;aspect-ratio:9/16;border-radius:14px;position:relative;overflow:hidden;background:linear-gradient(168deg,#3d5d80,#15233a);color:#fff;box-shadow:0 14px 34px rgba(0,0,0,.45)}
...
.bs-rail .mini-feed .img{height:72px;background:linear-gradient(160deg,#3d5d80,#15233a)}
.bs-rail .mini-feed .ft{display:flex;justify-content:space-between;align-items:center;background:#f3f4f6;padding:5px 7px}
...
.bs-rail .rail-stage small{color:#8d96a8;font-size:11px;text-align:center;line-height:1.5}
.bs-rail .rail-stage small b{color:#d6dbe6}
