...
import { SidebarThemeToggle } from "@/ui/sidebar-theme-toggle";
import { deriveCapabilities } from "@/modules/auth/capabilities";
import type { WorkspaceRole } from "@/modules/auth/access-control";
