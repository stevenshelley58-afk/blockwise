...
export const HOMEPAGE_PLANS: readonly HomepagePlan[] = [
  {
    ...
    outcome: "Make and download your first ad pack without adding a card.",
    included: ["One free ad pack: one Feed ad and one Story ad", "Download and run them yourself"],
    details: ["Saved designs and leads stay available", "Meta ad spend is paid separately to Meta"],
    note: "Creating and downloading ads is free. Publishing an ad needs a card and starts a 7-day trial.",
  ...
  },
  {
    ...
    note: "Publishing an ad starts a 7-day trial. After the trial this plan renews at A$249 per month until you cancel.",
