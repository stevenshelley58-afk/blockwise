...
function validateMetaLeadAdPack(_meta: AdBuilderPlatformCopyPack["meta"]) { return { issues: [] as ComplianceIssue[] }; }
function validateGoogleSearchPack(_search: AdBuilderPlatformCopyPack["googleSearch"]) { return { issues: [] as ComplianceIssue[] }; }
function validateGoogleAssetPack(_assets: AdBuilderPlatformCopyPack["googlePmax"]) { return { issues: [] as ComplianceIssue[] }; }
...
export function runAdBuilderComplianceReview(input: {
...
function reviewCopyText(copyPack: AdBuilderPlatformCopyPack): ComplianceIssue[] {
  const text = [
