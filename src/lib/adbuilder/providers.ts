import {
  adBuilderTemplateAnalysisSchema,
  adBuilderCloneQualityReviewSchema,
  googleAssetPackSchema,
  googleSearchPackSchema,
  metaLeadAdPackSchema,
  type GoogleAssetPack,
  type AdBuilderTemplateAnalysis,
  type AdBuilderCloneQualityReview,
...
export type ProviderSchemaName = "metaLeadAdPack" | "googleSearchPack" | "googleAssetPack" | "adBuilderTemplateAnalysis" | "adBuilderCloneQualityReview";

export type ProviderValidationResult =
  | {
      ok: true;
      value: MetaLeadAdPack | GoogleSearchPack | GoogleAssetPack | AdBuilderTemplateAnalysis | AdBuilderCloneQualityReview;
      repaired: boolean;
      error?: never;
    }
  | {
