...
const sourceAdFileSchema = z.string().regex(
  /^[A-Za-z0-9._-]+\/[A-Za-z0-9._-]+\.(?:jpe?g|png|webp)$/i,
  "must be a relative image path inside the source archive",
);
  ...
  provenance: z.object({
    sourceAd: z
      .object({
        ...
        file: sourceAdFileSchema.optional(),
