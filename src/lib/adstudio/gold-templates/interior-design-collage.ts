...
function image(id: string, rect: ReturnType<typeof b>, role: "primary" | "secondary", anchor: "center" | "top" | "bottom" | "left" | "right" = "center"): TemplateLayer { return { id, type: "image_slot", rect, role, fit: "cover", anchor, mask: "none", editorLabel: imageLabel(id, role), guidance: imageGuidance(role), required: true }; }
