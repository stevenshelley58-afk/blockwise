...
const EYEBROW = "Story Downsizer Guide";
const SAMPLE_STAT = "3 local signals";
const SAMPLE_ADDRESS = "49 Preston Point Road, Karrinyup";

export const meta039Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Story 039 - Story Downsizer Guide",
  goal: "downsizer_leads",
  offerId: "downsizer_guide",
  imageBriefId: "IMG-STORY-DOWNSIZER",
  promptHint: "Story 039 - Story Downsizer Guide: local standalone full-screen story-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
    headline: "A simpler next move starts here",
    primaryText: "Give downsizers one calm planning step and one direct contact action.",
    description: "downsizer story",
    cta: "Plan move",
  },
  sampleStyle: {
  ...
  tone: "urgent_listing",
  sampleSuburb: "Karrinyup",
  sampleState: "WA",
  agencyName: "Civic Property Co",
  agentName: "Sofia Reid",
  address: "49 Preston Point Road, Karrinyup",
  propertyDetail: "downsizer story",
  resultDetail: "Move planning",
  sampleCardImagePath: "adstudio-samples/gold/meta_039.png"
},
  sampleCardImageUrl: `/adstudio-samples/gold/${ID}.png?v=${VERSION}`,
  designs: meta039Designs(),
  evidenceScore: 97,
  ...
  exemplars: ["meta_ad_candidates/local/meta_039.png"],
};

export const meta039Sample = {
  ...
  text: {
    eyebrow: "Story Downsizer Guide",
    headline: "A simpler next move starts here",
    body: "Give downsizers one calm planning step and one direct contact action.",
    cta: "Plan move",
    address: "49 Preston Point Road, Karrinyup",
...
function meta039Designs(): TemplateDesignSet {
  return {
