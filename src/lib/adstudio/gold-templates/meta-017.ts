...
const EYEBROW = "Recent Sales Proof";
const SAMPLE_STAT = "3 local signals";
const SAMPLE_ADDRESS = "27 Marine Parade, Wembley";

export const meta017Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Feed 017 - Recent Sales Proof",
  goal: "seller_leads",
  offerId: "recent_sales_report",
  imageBriefId: "IMG-SALES-PROOF",
  promptHint: "Feed 017 - Recent Sales Proof: local standalone feed-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
    headline: "Recent sales near Wembley",
    primaryText: "Use comparable local activity to plan your next property decision.",
  ...
  address: "27 Marine Parade, Wembley",
  propertyDetail: "recent sales",
  resultDetail: "Sales proof",
  sampleCardImagePath: "adstudio-samples/gold/meta_017.png"
},
  sampleCardImageUrl: `/adstudio-samples/gold/${ID}.png?v=${VERSION}`,
  designs: meta017Designs(),
  evidenceScore: 91,
  ...
  exemplars: ["meta_ad_candidates/local/meta_017.png"],
};

export const meta017Sample = {
  ...
  text: {
    eyebrow: "Recent Sales Proof",
    headline: "Recent sales near Wembley",
    body: "Use comparable local activity to plan your next property decision.",
    cta: "See results",
    address: "27 Marine Parade, Wembley",
...
function meta017Designs(): TemplateDesignSet {
  return {
