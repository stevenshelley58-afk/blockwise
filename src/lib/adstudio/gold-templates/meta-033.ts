...
const SAMPLE_ADDRESS = "43 Preston Point Road, South Perth";

export const meta033Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Story 033 - Story Open Home",
  goal: "open_home_followup",
  offerId: "open_home_followup",
  imageBriefId: "IMG-STORY-OPEN-HOME",
  promptHint: "Story 033 - Story Open Home: local standalone full-screen story-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
  ...
  agentName: "Mia Hart",
  address: "43 Preston Point Road, South Perth",
  propertyDetail: "open home follow-up",
  resultDetail: "Follow-up",
  sampleCardImagePath: "adstudio-samples/gold/meta_033.png"
},
  sampleCardImageUrl: `/adstudio-samples/gold/${ID}.png?v=${VERSION}`,
  designs: meta033Designs(),
  evidenceScore: 91,
  ...
  exemplars: ["meta_ad_candidates/local/meta_033.png"],
};

export const meta033Sample = {
...
function meta033Designs(): TemplateDesignSet {
  return {
