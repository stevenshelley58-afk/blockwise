...
const SAMPLE_ADDRESS = "55 Preston Point Road, Cottesloe";

export const meta045Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Story 045 - Story Market Pulse",
  goal: "market_update_leads",
  offerId: "suburb_market_report",
  imageBriefId: "IMG-STORY-MARKET",
  promptHint: "Story 045 - Story Market Pulse: local standalone full-screen story-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
    headline: "Cottesloe market in 30 seconds",
  ...
  address: "55 Preston Point Road, Cottesloe",
  propertyDetail: "market story",
  resultDetail: "Market pulse",
  sampleCardImagePath: "adstudio-samples/gold/meta_045.png"
},
  sampleCardImageUrl: `/adstudio-samples/gold/${ID}.png?v=${VERSION}`,
  designs: meta045Designs(),
  evidenceScore: 95,
  ...
  exemplars: ["meta_ad_candidates/local/meta_045.png"],
};

export const meta045Sample = {
...
function meta045Designs(): TemplateDesignSet {
  return {
