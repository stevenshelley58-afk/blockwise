...
const SAMPLE_ADDRESS = "14 Cambridge Street, North Perth";

export const meta004Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Feed 004 - Free Appraisal Card",
  goal: "appraisal_bookings",
  offerId: "home_value_update",
  imageBriefId: "IMG-APPRAISAL-CARD",
  promptHint: "Feed 004 - Free Appraisal Card: local standalone feed-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
  ...
  address: "14 Cambridge Street, North Perth",
  propertyDetail: "price position",
  resultDetail: "Price check",
  sampleCardImagePath: "adstudio-samples/gold/meta_004.png"
},
  sampleCardImageUrl: `/adstudio-samples/gold/${ID}.png?v=${VERSION}`,
  designs: meta004Designs(),
  evidenceScore: 94,
  ...
  exemplars: ["meta_ad_candidates/local/meta_004.png"],
};

export const meta004Sample = {
...
function meta004Designs(): TemplateDesignSet {
  return {
