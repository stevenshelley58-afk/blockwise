...
const SAMPLE_ADDRESS = "48 Albany Highway, Floreat";

export const meta038Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Story 038 - Story Buyer Demand",
  goal: "buyer_leads",
  offerId: "buyer_list",
  imageBriefId: "IMG-STORY-BUYERS",
  promptHint: "Story 038 - Story Buyer Demand: local standalone full-screen story-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
    headline: "Buyers looking in Floreat",
  ...
  address: "48 Albany Highway, Floreat",
  propertyDetail: "buyer demand",
  resultDetail: "Buyer demand",
  sampleCardImagePath: "adstudio-samples/gold/meta_038.png"
},
  sampleCardImageUrl: `/adstudio-samples/gold/${ID}.png?v=${VERSION}`,
  designs: meta038Designs(),
  evidenceScore: 96,
  ...
  exemplars: ["meta_ad_candidates/local/meta_038.png"],
};

export const meta038Sample = {
...
function meta038Designs(): TemplateDesignSet {
  return {
