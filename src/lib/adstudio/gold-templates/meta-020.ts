...
const EYEBROW = "Open Home Follow Up";
const SAMPLE_STAT = "3 local signals";
const SAMPLE_ADDRESS = "30 Albany Highway, Bassendean";

export const meta020Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Feed 020 - Open Home Follow Up",
  goal: "open_home_followup",
  offerId: "open_home_followup",
  imageBriefId: "IMG-OPEN-HOME",
  promptHint: "Feed 020 - Open Home Follow Up: local standalone feed-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
    headline: "After the Bassendean open home",
    primaryText: "Turn inspection interest into a practical next-step conversation.",
  ...
  address: "30 Albany Highway, Bassendean",
  propertyDetail: "inspection follow-up",
  resultDetail: "Open home note",
  sampleCardImagePath: "adstudio-samples/gold/meta_020.png"
},
  sampleCardImageUrl: `/adstudio-samples/gold/${ID}.png?v=${VERSION}`,
  designs: meta020Designs(),
  evidenceScore: 94,
  ...
  exemplars: ["meta_ad_candidates/local/meta_020.png"],
};

export const meta020Sample = {
  ...
  text: {
    eyebrow: "Open Home Follow Up",
    headline: "After the Bassendean open home",
    body: "Turn inspection interest into a practical next-step conversation.",
    cta: "Follow up",
    address: "30 Albany Highway, Bassendean",
...
function meta020Designs(): TemplateDesignSet {
  return {
