...
const SAMPLE_ADDRESS = "57 Marine Parade, Maylands";

export const meta047Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Story 047 - Story Downsizer Guide",
  goal: "downsizer_leads",
  offerId: "downsizer_guide",
  imageBriefId: "IMG-STORY-DOWNSIZER",
  promptHint: "Story 047 - Story Downsizer Guide: local standalone full-screen story-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
  ...
  exemplars: ["meta_ad_candidates/local/meta_047.png"],
};

export const meta047Sample = {
  photoFile: "au-modern-coastal.png",
  photoFiles: {
    secondary_photo: "au-urban-townhouse.png",
    agent_headshot: "au-modern-coastal.png"
  },
  text: {
...
function meta047Designs(): TemplateDesignSet {
  return {
