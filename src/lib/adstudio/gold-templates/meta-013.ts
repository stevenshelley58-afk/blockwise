...
const SAMPLE_ADDRESS = "23 Rokeby Road, South Perth";

export const meta013Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Feed 013 - Seller Prep List",
  goal: "seller_leads",
  offerId: "seller_prep_checklist",
  imageBriefId: "IMG-SELLER-CHECKLIST",
  promptHint: "Feed 013 - Seller Prep List: local standalone feed-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
    headline: "Before you list in South Perth",
  ...
  exemplars: ["meta_ad_candidates/local/meta_013.png"],
};

export const meta013Sample = {
...
function meta013Designs(): TemplateDesignSet {
  return {
