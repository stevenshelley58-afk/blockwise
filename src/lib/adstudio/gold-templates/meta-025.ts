...
const SAMPLE_ADDRESS = "35 Rokeby Road, Cottesloe";

export const meta025Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Feed 025 - Buyer Match Note",
  goal: "buyer_leads",
  offerId: "buyer_list",
  imageBriefId: "IMG-BUYER-MATCH",
  promptHint: "Feed 025 - Buyer Match Note: local standalone feed-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
    headline: "Buyers are asking about Cottesloe",
  ...
  address: "35 Rokeby Road, Cottesloe",
  propertyDetail: "buyer demand",
  resultDetail: "Buyer match",
  sampleCardImagePath: "adstudio-samples/gold/meta_025.png"
},
  sampleCardImageUrl: `/adstudio-samples/gold/${ID}.png?v=${VERSION}`,
  designs: meta025Designs(),
  evidenceScore: 91,
  ...
  exemplars: ["meta_ad_candidates/local/meta_025.png"],
};

export const meta025Sample = {
...
function meta025Designs(): TemplateDesignSet {
  return {
