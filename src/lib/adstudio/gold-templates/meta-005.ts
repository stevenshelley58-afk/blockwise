...
const SAMPLE_ADDRESS = "15 Marine Parade, Cottesloe";

export const meta005Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Feed 005 - Buyer Match Note",
  goal: "buyer_leads",
  offerId: "buyer_list",
  imageBriefId: "IMG-BUYER-MATCH",
  promptHint: "Feed 005 - Buyer Match Note: local standalone feed-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
  ...
  address: "15 Marine Parade, Cottesloe",
  propertyDetail: "buyer demand",
  resultDetail: "Buyer match",
  sampleCardImagePath: "adstudio-samples/gold/meta_005.png"
},
  sampleCardImageUrl: `/adstudio-samples/gold/${ID}.png?v=${VERSION}`,
  designs: meta005Designs(),
  evidenceScore: 95,
  ...
  exemplars: ["meta_ad_candidates/local/meta_005.png"],
};

export const meta005Sample = {
...
function meta005Designs(): TemplateDesignSet {
  return {
