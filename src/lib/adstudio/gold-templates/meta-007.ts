...
const SAMPLE_ADDRESS = "17 Rokeby Road, Maylands";

export const meta007Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Feed 007 - Recent Sales Proof",
  goal: "seller_leads",
  offerId: "recent_sales_report",
  imageBriefId: "IMG-SALES-PROOF",
  promptHint: "Feed 007 - Recent Sales Proof: local standalone feed-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
    headline: "Recent sales near Maylands",
  ...
  exemplars: ["meta_ad_candidates/local/meta_007.png"],
};

export const meta007Sample = {
...
function meta007Designs(): TemplateDesignSet {
  return {
