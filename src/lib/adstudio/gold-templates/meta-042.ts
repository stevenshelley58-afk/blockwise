...
const SAMPLE_ADDRESS = "52 Beaufort Street, Bicton";

export const meta042Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Story 042 - Story Sold Nurture",
  goal: "listing_nurture",
  offerId: "market_report",
  imageBriefId: "IMG-STORY-NURTURE",
  promptHint: "Story 042 - Story Sold Nurture: local standalone full-screen story-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
  ...
  address: "52 Beaufort Street, Bicton",
  propertyDetail: "nurture story",
  resultDetail: "Warm update",
  sampleCardImagePath: "adstudio-samples/gold/meta_042.png"
},
  sampleCardImageUrl: `/adstudio-samples/gold/${ID}.png?v=${VERSION}`,
  designs: meta042Designs(),
  evidenceScore: 92,
  ...
  exemplars: ["meta_ad_candidates/local/meta_042.png"],
};

export const meta042Sample = {
...
function meta042Designs(): TemplateDesignSet {
  return {
