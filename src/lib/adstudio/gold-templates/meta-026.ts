...
const SAMPLE_ADDRESS = "36 Albany Highway, Victoria Park";

export const meta026Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Feed 026 - Just Listed Brief",
  goal: "seller_leads",
  offerId: "listing_inquiries",
  imageBriefId: "IMG-LISTING-BRIEF",
  promptHint: "Feed 026 - Just Listed Brief: local standalone feed-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
  ...
  address: "36 Albany Highway, Victoria Park",
  propertyDetail: "new listing",
  resultDetail: "Listing brief",
  sampleCardImagePath: "adstudio-samples/gold/meta_026.png"
},
  sampleCardImageUrl: `/adstudio-samples/gold/${ID}.png?v=${VERSION}`,
  designs: meta026Designs(),
  evidenceScore: 92,
  ...
  exemplars: ["meta_ad_candidates/local/meta_026.png"],
};

export const meta026Sample = {
...
function meta026Designs(): TemplateDesignSet {
  return {
