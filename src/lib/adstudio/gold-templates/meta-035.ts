...
const SAMPLE_ADDRESS = "45 Marine Parade, Leederville";

export const meta035Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Story 035 - Story Listing Launch",
  goal: "seller_leads",
  offerId: "listing_inquiries",
  imageBriefId: "IMG-STORY-LISTING",
  promptHint: "Story 035 - Story Listing Launch: local standalone full-screen story-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
    headline: "New opportunity in Leederville",
  ...
  address: "45 Marine Parade, Leederville",
  propertyDetail: "listing launch",
  resultDetail: "New listing",
  sampleCardImagePath: "adstudio-samples/gold/meta_035.png"
},
  sampleCardImageUrl: `/adstudio-samples/gold/${ID}.png?v=${VERSION}`,
  designs: meta035Designs(),
  evidenceScore: 93,
  ...
  exemplars: ["meta_ad_candidates/local/meta_035.png"],
};

export const meta035Sample = {
...
function meta035Designs(): TemplateDesignSet {
  return {
