...
function image(id: string, rect: ReturnType<typeof box>, role: "primary" | "secondary", anchor: "center" | "top" | "bottom" = "center", mask: "none" | "circle" = "none"): TemplateLayer { return { id, type: "image_slot", rect, role, fit: "cover", anchor, mask, editorLabel: imageLabel(id, role), guidance: imageGuidance(role), required: true }; }
