...
const EYEBROW = "Investor Yield Card";
const SAMPLE_STAT = "15 min read";
const SAMPLE_ADDRESS = "28 Beaufort Street, Floreat";

export const meta018Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Feed 018 - Investor Yield Card",
  goal: "investor_leads",
  offerId: "investor_suburb_snapshot",
  imageBriefId: "IMG-INVESTOR-SNAPSHOT",
  promptHint: "Feed 018 - Investor Yield Card: local standalone feed-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
    headline: "Floreat investor snapshot",
    primaryText: "A compact rent, demand, and condition check for local investors.",
    description: "rental snapshot",
    cta: "Get snapshot",
  },
  sampleStyle: {
  ...
  tone: "soft_organic",
  sampleSuburb: "Floreat",
  sampleState: "WA",
  agencyName: "Blockwise Realty",
  agentName: "Eli Turner",
  address: "28 Beaufort Street, Floreat",
  propertyDetail: "rental snapshot",
  resultDetail: "Investor note",
  sampleCardImagePath: "adstudio-samples/gold/meta_018.png"
},
  sampleCardImageUrl: `/adstudio-samples/gold/${ID}.png?v=${VERSION}`,
  designs: meta018Designs(),
  evidenceScore: 92,
  ...
  exemplars: ["meta_ad_candidates/local/meta_018.png"],
};

export const meta018Sample = {
  ...
  text: {
    eyebrow: "Investor Yield Card",
    headline: "Floreat investor snapshot",
    body: "A compact rent, demand, and condition check for local investors.",
    cta: "Get snapshot",
    address: "28 Beaufort Street, Floreat",
    stat: "15 min read",
...
function meta018Designs(): TemplateDesignSet {
  return {
