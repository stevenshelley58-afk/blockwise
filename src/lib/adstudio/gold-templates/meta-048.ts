...
const SAMPLE_ADDRESS = "58 Beaufort Street, Scarborough";

export const meta048Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Story 048 - Story Investor Check",
  goal: "investor_leads",
  offerId: "investor_suburb_snapshot",
  imageBriefId: "IMG-STORY-INVESTOR",
  promptHint: "Story 048 - Story Investor Check: local standalone full-screen story-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
    headline: "Scarborough rental check",
  ...
  address: "58 Beaufort Street, Scarborough",
  propertyDetail: "investor story",
  resultDetail: "Rental check",
  sampleCardImagePath: "adstudio-samples/gold/meta_048.png"
},
  sampleCardImageUrl: `/adstudio-samples/gold/${ID}.png?v=${VERSION}`,
  designs: meta048Designs(),
  evidenceScore: 90,
  ...
  exemplars: ["meta_ad_candidates/local/meta_048.png"],
};

export const meta048Sample = {
...
function meta048Designs(): TemplateDesignSet {
  return {
