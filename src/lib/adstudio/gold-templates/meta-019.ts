...
const SAMPLE_ADDRESS = "29 Rokeby Road, Karrinyup";

export const meta019Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Feed 019 - Downsizer Plan",
  goal: "downsizer_leads",
  offerId: "downsizer_guide",
  imageBriefId: "IMG-DOWNSIZER-PLAN",
  promptHint: "Feed 019 - Downsizer Plan: local standalone feed-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
    headline: "Planning a simpler move in Karrinyup?",
  ...
  exemplars: ["meta_ad_candidates/local/meta_019.png"],
};

export const meta019Sample = {
...
function meta019Designs(): TemplateDesignSet {
  return {
