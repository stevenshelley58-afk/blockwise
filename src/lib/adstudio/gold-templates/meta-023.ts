...
const SAMPLE_ADDRESS = "33 Marine Parade, Fremantle";

export const meta023Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Feed 023 - Seller Prep List",
  goal: "seller_leads",
  offerId: "seller_prep_checklist",
  imageBriefId: "IMG-SELLER-CHECKLIST",
  promptHint: "Feed 023 - Seller Prep List: local standalone feed-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
  ...
  exemplars: ["meta_ad_candidates/local/meta_023.png"],
};

export const meta023Sample = {
...
function meta023Designs(): TemplateDesignSet {
  return {
