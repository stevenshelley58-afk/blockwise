...
const SAMPLE_ADDRESS = "18 Albany Highway, Scarborough";

export const meta008Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Feed 008 - Investor Yield Card",
  goal: "investor_leads",
  offerId: "investor_suburb_snapshot",
  imageBriefId: "IMG-INVESTOR-SNAPSHOT",
  promptHint: "Feed 008 - Investor Yield Card: local standalone feed-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
    headline: "Scarborough investor snapshot",
  ...
  address: "18 Albany Highway, Scarborough",
  propertyDetail: "rental snapshot",
  resultDetail: "Investor note",
  sampleCardImagePath: "adstudio-samples/gold/meta_008.png"
},
  sampleCardImageUrl: `/adstudio-samples/gold/${ID}.png?v=${VERSION}`,
  designs: meta008Designs(),
  evidenceScore: 90,
  ...
  exemplars: ["meta_ad_candidates/local/meta_008.png"],
};

export const meta008Sample = {
...
function meta008Designs(): TemplateDesignSet {
  return {
