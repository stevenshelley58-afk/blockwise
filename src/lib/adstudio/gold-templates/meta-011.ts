...
const SAMPLE_ADDRESS = "21 Marine Parade, Applecross";

export const meta011Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Feed 011 - Nurture Update",
  goal: "listing_nurture",
  offerId: "market_report",
  imageBriefId: "IMG-NURTURE-UPDATE",
  promptHint: "Feed 011 - Nurture Update: local standalone feed-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
    headline: "Still watching Applecross?",
  ...
  exemplars: ["meta_ad_candidates/local/meta_011.png"],
};

export const meta011Sample = {
...
function meta011Designs(): TemplateDesignSet {
  return {
