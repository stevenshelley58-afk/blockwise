...
const EYEBROW = "Just Listed Brief";
const SAMPLE_STAT = "Fresh context";
const SAMPLE_ADDRESS = "26 Cambridge Street, Inglewood";

export const meta016Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Feed 016 - Just Listed Brief",
  goal: "seller_leads",
  offerId: "listing_inquiries",
  imageBriefId: "IMG-LISTING-BRIEF",
  promptHint: "Feed 016 - Just Listed Brief: local standalone feed-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
    headline: "A fresh listing angle for Inglewood",
    primaryText: "Show the key features clearly with a calm, direct enquiry path.",
  ...
  address: "26 Cambridge Street, Inglewood",
  propertyDetail: "new listing",
  resultDetail: "Listing brief",
  sampleCardImagePath: "adstudio-samples/gold/meta_016.png"
},
  sampleCardImageUrl: `/adstudio-samples/gold/${ID}.png?v=${VERSION}`,
  designs: meta016Designs(),
  evidenceScore: 90,
  ...
  exemplars: ["meta_ad_candidates/local/meta_016.png"],
};

export const meta016Sample = {
  ...
  text: {
    eyebrow: "Just Listed Brief",
    headline: "A fresh listing angle for Inglewood",
    body: "Show the key features clearly with a calm, direct enquiry path.",
    cta: "View details",
    address: "26 Cambridge Street, Inglewood",
    stat: "Fresh context",
...
function meta016Designs(): TemplateDesignSet {
  return {
