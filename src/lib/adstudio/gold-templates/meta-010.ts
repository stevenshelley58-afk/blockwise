...
const SAMPLE_ADDRESS = "20 Cambridge Street, Subiaco";

export const meta010Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Feed 010 - Open Home Follow Up",
  goal: "open_home_followup",
  offerId: "open_home_followup",
  imageBriefId: "IMG-OPEN-HOME",
  promptHint: "Feed 010 - Open Home Follow Up: local standalone feed-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
    headline: "After the Subiaco open home",
  ...
  exemplars: ["meta_ad_candidates/local/meta_010.png"],
};

export const meta010Sample = {
...
function meta010Designs(): TemplateDesignSet {
  return {
