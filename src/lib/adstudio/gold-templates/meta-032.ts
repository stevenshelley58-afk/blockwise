...
const SAMPLE_ADDRESS = "42 Albany Highway, Como";

export const meta032Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Story 032 - Story Investor Check",
  goal: "investor_leads",
  offerId: "investor_suburb_snapshot",
  imageBriefId: "IMG-STORY-INVESTOR",
  promptHint: "Story 032 - Story Investor Check: local standalone full-screen story-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
    headline: "Como rental check",
  ...
  exemplars: ["meta_ad_candidates/local/meta_032.png"],
};

export const meta032Sample = {
...
function meta032Designs(): TemplateDesignSet {
  return {
