...
const EYEBROW = "Downsizer Plan";
const SAMPLE_STAT = "15 min read";
const SAMPLE_ADDRESS = "19 Preston Point Road, Mount Lawley";

export const meta009Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Feed 009 - Downsizer Plan",
  goal: "downsizer_leads",
  offerId: "downsizer_guide",
  imageBriefId: "IMG-DOWNSIZER-PLAN",
  promptHint: "Feed 009 - Downsizer Plan: local standalone feed-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
    headline: "Planning a simpler move in Mount Lawley?",
    primaryText: "Map timing, presentation, and next-step options before you list.",
    description: "downsizer planning",
    cta: "Plan move",
  },
  sampleStyle: {
  ...
  sampleState: "WA",
  agencyName: "Laneway Realty",
  agentName: "Sofia Reid",
  address: "19 Preston Point Road, Mount Lawley",
  propertyDetail: "downsizer planning",
  resultDetail: "Move plan",
  sampleCardImagePath: "adstudio-samples/gold/meta_009.png"
},
  sampleCardImageUrl: `/adstudio-samples/gold/${ID}.png?v=${VERSION}`,
  designs: meta009Designs(),
  evidenceScore: 91,
  ...
  exemplars: ["meta_ad_candidates/local/meta_009.png"],
};

export const meta009Sample = {
  ...
  text: {
    eyebrow: "Downsizer Plan",
    headline: "Planning a simpler move in Mount Lawley?",
    body: "Map timing, presentation, and next-step options before you list.",
    cta: "Plan move",
    address: "19 Preston Point Road, Mount Lawley",
    stat: "15 min read",
...
function meta009Designs(): TemplateDesignSet {
  return {
