...
const SAMPLE_ADDRESS = "46 Beaufort Street, Inglewood";

export const meta036Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Story 036 - Story Appraisal",
  goal: "appraisal_bookings",
  offerId: "home_value_update",
  imageBriefId: "IMG-STORY-APPRAISAL",
  promptHint: "Story 036 - Story Appraisal: local standalone full-screen story-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
    headline: "Inglewood owners: check your price",
  ...
  address: "46 Beaufort Street, Inglewood",
  propertyDetail: "appraisal lead",
  resultDetail: "Price check",
  sampleCardImagePath: "adstudio-samples/gold/meta_036.png"
},
  sampleCardImageUrl: `/adstudio-samples/gold/${ID}.png?v=${VERSION}`,
  designs: meta036Designs(),
  evidenceScore: 94,
  ...
  exemplars: ["meta_ad_candidates/local/meta_036.png"],
};

export const meta036Sample = {
...
function meta036Designs(): TemplateDesignSet {
  return {
