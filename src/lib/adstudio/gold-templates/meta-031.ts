...
const SAMPLE_ADDRESS = "41 Rokeby Road, Applecross";

export const meta031Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Story 031 - Story Downsizer Guide",
  goal: "downsizer_leads",
  offerId: "downsizer_guide",
  imageBriefId: "IMG-STORY-DOWNSIZER",
  promptHint: "Story 031 - Story Downsizer Guide: local standalone full-screen story-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
  ...
  exemplars: ["meta_ad_candidates/local/meta_031.png"],
};

export const meta031Sample = {
...
function meta031Designs(): TemplateDesignSet {
  return {
