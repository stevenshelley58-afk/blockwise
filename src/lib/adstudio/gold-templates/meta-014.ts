...
const SAMPLE_ADDRESS = "24 Albany Highway, Claremont";

export const meta014Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Feed 014 - Free Appraisal Card",
  goal: "appraisal_bookings",
  offerId: "home_value_update",
  imageBriefId: "IMG-APPRAISAL-CARD",
  promptHint: "Feed 014 - Free Appraisal Card: local standalone feed-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
    headline: "Know your Claremont price position",
  ...
  address: "24 Albany Highway, Claremont",
  propertyDetail: "price position",
  resultDetail: "Price check",
  sampleCardImagePath: "adstudio-samples/gold/meta_014.png"
},
  sampleCardImageUrl: `/adstudio-samples/gold/${ID}.png?v=${VERSION}`,
  designs: meta014Designs(),
  evidenceScore: 96,
  ...
  exemplars: ["meta_ad_candidates/local/meta_014.png"],
};

export const meta014Sample = {
...
function meta014Designs(): TemplateDesignSet {
  return {
