...
const EYEBROW = "Story Market Pulse";
const SAMPLE_STAT = "Fresh context";
const SAMPLE_ADDRESS = "39 Marine Parade, Mount Lawley";

export const meta029Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Story 029 - Story Market Pulse",
  goal: "market_update_leads",
  offerId: "suburb_market_report",
  imageBriefId: "IMG-STORY-MARKET",
  promptHint: "Story 029 - Story Market Pulse: local standalone full-screen story-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
    headline: "Mount Lawley market in 30 seconds",
    primaryText: "Lead with one useful market point and a direct report request.",
    description: "market story",
    cta: "Get report",
  },
  sampleStyle: {
  ...
  address: "39 Marine Parade, Mount Lawley",
  propertyDetail: "market story",
  resultDetail: "Market pulse",
  sampleCardImagePath: "adstudio-samples/gold/meta_029.png"
},
  sampleCardImageUrl: `/adstudio-samples/gold/${ID}.png?v=${VERSION}`,
  designs: meta029Designs(),
  evidenceScore: 95,
  ...
  exemplars: ["meta_ad_candidates/local/meta_029.png"],
};

export const meta029Sample = {
  ...
  text: {
    eyebrow: "Story Market Pulse",
    headline: "Mount Lawley market in 30 seconds",
    body: "Lead with one useful market point and a direct report request.",
    cta: "Get report",
    address: "39 Marine Parade, Mount Lawley",
    stat: "Fresh context",
...
function meta029Designs(): TemplateDesignSet {
  return {
