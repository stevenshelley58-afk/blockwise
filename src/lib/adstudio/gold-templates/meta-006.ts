...
const SAMPLE_ADDRESS = "16 Beaufort Street, Victoria Park";

export const meta006Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Feed 006 - Just Listed Brief",
  goal: "seller_leads",
  offerId: "listing_inquiries",
  imageBriefId: "IMG-LISTING-BRIEF",
  promptHint: "Feed 006 - Just Listed Brief: local standalone feed-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
    headline: "A fresh listing angle for Victoria Park",
  ...
  address: "16 Beaufort Street, Victoria Park",
  propertyDetail: "new listing",
  resultDetail: "Listing brief",
  sampleCardImagePath: "adstudio-samples/gold/meta_006.png"
},
  sampleCardImageUrl: `/adstudio-samples/gold/${ID}.png?v=${VERSION}`,
  designs: meta006Designs(),
  evidenceScore: 96,
  ...
  exemplars: ["meta_ad_candidates/local/meta_006.png"],
};

export const meta006Sample = {
...
function meta006Designs(): TemplateDesignSet {
  return {
