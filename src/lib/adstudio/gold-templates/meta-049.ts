...
const EYEBROW = "Story Open Home";
const SAMPLE_STAT = "15 min read";
const SAMPLE_ADDRESS = "59 Rokeby Road, Mount Lawley";

export const meta049Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Story 049 - Story Open Home",
  goal: "open_home_followup",
  offerId: "open_home_followup",
  imageBriefId: "IMG-STORY-OPEN-HOME",
  promptHint: "Story 049 - Story Open Home: local standalone full-screen story-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
    headline: "Open home follow-up",
    primaryText: "Convert inspection attention into a useful next-step conversation.",
    description: "open home follow-up",
    cta: "Book chat",
  },
  sampleStyle: {
  ...
  address: "59 Rokeby Road, Mount Lawley",
  propertyDetail: "open home follow-up",
  resultDetail: "Follow-up",
  sampleCardImagePath: "adstudio-samples/gold/meta_049.png"
},
  sampleCardImageUrl: `/adstudio-samples/gold/${ID}.png?v=${VERSION}`,
  designs: meta049Designs(),
  evidenceScore: 91,
  ...
  exemplars: ["meta_ad_candidates/local/meta_049.png"],
};

export const meta049Sample = {
  ...
  text: {
    eyebrow: "Story Open Home",
    headline: "Open home follow-up",
    body: "Convert inspection attention into a useful next-step conversation.",
    cta: "Book chat",
    address: "59 Rokeby Road, Mount Lawley",
    stat: "15 min read",
...
function meta049Designs(): TemplateDesignSet {
  return {
