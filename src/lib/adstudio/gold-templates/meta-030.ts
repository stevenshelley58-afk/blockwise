...
const SAMPLE_ADDRESS = "40 Beaufort Street, Subiaco";

export const meta030Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Story 030 - Story Buyer Demand",
  goal: "buyer_leads",
  offerId: "buyer_list",
  imageBriefId: "IMG-STORY-BUYERS",
  promptHint: "Story 030 - Story Buyer Demand: local standalone full-screen story-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
    headline: "Buyers looking in Subiaco",
  ...
  address: "40 Beaufort Street, Subiaco",
  propertyDetail: "buyer demand",
  resultDetail: "Buyer demand",
  sampleCardImagePath: "adstudio-samples/gold/meta_030.png"
},
  sampleCardImageUrl: `/adstudio-samples/gold/${ID}.png?v=${VERSION}`,
  designs: meta030Designs(),
  evidenceScore: 96,
  ...
  exemplars: ["meta_ad_candidates/local/meta_030.png"],
};

export const meta030Sample = {
...
function meta030Designs(): TemplateDesignSet {
  return {
