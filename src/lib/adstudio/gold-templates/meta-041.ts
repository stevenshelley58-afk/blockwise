...
const SAMPLE_ADDRESS = "51 Marine Parade, East Fremantle";

export const meta041Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Story 041 - Story Open Home",
  goal: "open_home_followup",
  offerId: "open_home_followup",
  imageBriefId: "IMG-STORY-OPEN-HOME",
  promptHint: "Story 041 - Story Open Home: local standalone full-screen story-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
  ...
  address: "51 Marine Parade, East Fremantle",
  propertyDetail: "open home follow-up",
  resultDetail: "Follow-up",
  sampleCardImagePath: "adstudio-samples/gold/meta_041.png"
},
  sampleCardImageUrl: `/adstudio-samples/gold/${ID}.png?v=${VERSION}`,
  designs: meta041Designs(),
  evidenceScore: 91,
  ...
  exemplars: ["meta_ad_candidates/local/meta_041.png"],
};

export const meta041Sample = {
...
function meta041Designs(): TemplateDesignSet {
  return {
