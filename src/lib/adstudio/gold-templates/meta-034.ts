...
const SAMPLE_ADDRESS = "44 Cambridge Street, Claremont";

export const meta034Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Story 034 - Story Sold Nurture",
  goal: "listing_nurture",
  offerId: "market_report",
  imageBriefId: "IMG-STORY-NURTURE",
  promptHint: "Story 034 - Story Sold Nurture: local standalone full-screen story-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
  ...
  address: "44 Cambridge Street, Claremont",
  propertyDetail: "nurture story",
  resultDetail: "Warm update",
  sampleCardImagePath: "adstudio-samples/gold/meta_034.png"
},
  sampleCardImageUrl: `/adstudio-samples/gold/${ID}.png?v=${VERSION}`,
  designs: meta034Designs(),
  evidenceScore: 92,
  ...
  exemplars: ["meta_ad_candidates/local/meta_034.png"],
};

export const meta034Sample = {
...
function meta034Designs(): TemplateDesignSet {
  return {
