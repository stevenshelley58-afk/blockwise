...
const SAMPLE_ADDRESS = "38 Cambridge Street, Scarborough";

export const meta028Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Story 028 - Story Appraisal",
  goal: "appraisal_bookings",
  offerId: "home_value_update",
  imageBriefId: "IMG-STORY-APPRAISAL",
  promptHint: "Story 028 - Story Appraisal: local standalone full-screen story-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
    headline: "Scarborough owners: check your price",
  ...
  address: "38 Cambridge Street, Scarborough",
  propertyDetail: "appraisal lead",
  resultDetail: "Price check",
  sampleCardImagePath: "adstudio-samples/gold/meta_028.png"
},
  sampleCardImageUrl: `/adstudio-samples/gold/${ID}.png?v=${VERSION}`,
  designs: meta028Designs(),
  evidenceScore: 94,
  ...
  exemplars: ["meta_ad_candidates/local/meta_028.png"],
};

export const meta028Sample = {
...
function meta028Designs(): TemplateDesignSet {
  return {
