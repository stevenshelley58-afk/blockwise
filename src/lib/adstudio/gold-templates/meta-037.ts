...
const SAMPLE_ADDRESS = "47 Rokeby Road, Wembley";

export const meta037Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Story 037 - Story Market Pulse",
  goal: "market_update_leads",
  offerId: "suburb_market_report",
  imageBriefId: "IMG-STORY-MARKET",
  promptHint: "Story 037 - Story Market Pulse: local standalone full-screen story-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
    headline: "Wembley market in 30 seconds",
  ...
  exemplars: ["meta_ad_candidates/local/meta_037.png"],
};

export const meta037Sample = {
...
function meta037Designs(): TemplateDesignSet {
  return {
