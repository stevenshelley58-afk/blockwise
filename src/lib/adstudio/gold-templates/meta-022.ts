...
const SAMPLE_ADDRESS = "32 Cambridge Street, Bicton";

export const meta022Template: AdStudioTemplate = {
  id: ID,
  templateKey: ID,
  name: "Feed 022 - Local Price Pulse",
  goal: "market_update_leads",
  offerId: "suburb_market_report",
  imageBriefId: "IMG-MARKET-PULSE",
  promptHint: "Feed 022 - Local Price Pulse: local standalone feed-led real estate ad template with editable copy, property photo slots, brand logo, and CTA.",
  source: "operator",
  status: "approved",
  sampleCopy: {
    headline: "What changed in Bicton this month?",
  ...
  exemplars: ["meta_ad_candidates/local/meta_022.png"],
};

export const meta022Sample = {
...
function meta022Designs(): TemplateDesignSet {
  return {
