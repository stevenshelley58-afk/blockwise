...
export const EMAIL_FIXTURES: Record<EmailKind, EmailMessage> = {
  "sign-in": {
    kind: "sign-in", eyebrow: "SECURE SIGN-IN", subject: "Your Blockwise sign-in code", preheader: "Use this one-time code to sign in.", greeting: "Hello Jordan,", heading: "Your sign-in code", intro: "Use this code to finish signing in to Blockwise. It expires in 10 minutes.", action: { label: "482913", href: "https://preview.blockwise.example/sign-in" }, note: "If you did not request this code, you can safely ignore this email.", transactional: true,
  },
  welcome: {
  ...
  "weekly-digest": {
    kind: "weekly-digest", eyebrow: "WEEKLY SUMMARY", subject: "Your Blockwise week in review", preheader: "A concise view of this week’s campaign activity.", greeting: "Hello Jordan,", heading: "Your week, in brief", intro: "Here is the operational picture for Northline Realty, ending Friday 6 September.", action: { label: "View campaign activity", href: "https://preview.blockwise.example/activity" }, details: [{ label: "New enquiries", value: "14" }, { label: "Campaigns live", value: "3" }, { label: "Items needing review", value: "2" }], note: "Figures are a summary for planning, not a final billing record.", transactional: false,
  },
  receipt: {
    kind: "receipt", eyebrow: "PAYMENT RECEIPT", subject: "Your Blockwise receipt", preheader: "A receipt for your September subscription.", greeting: "Hello Jordan,", heading: "Payment received", intro: "Thanks. We have recorded your subscription payment for Northline Realty.", action: { label: "View billing details", href: "https://preview.blockwise.example/billing" }, details: [{ label: "Amount", value: "A$49.00" }, { label: "Reference", value: "BW-2048" }, { label: "Paid", value: "6 September 2026" }], transactional: true,
  },
  security: {
