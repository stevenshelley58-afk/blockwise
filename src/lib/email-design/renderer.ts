...
function cta(message: EmailMessage, type: "inline" | "letter" | "full") {
  ...
  const code = message.oneTimeCode ? `<p class="muted" style="margin:22px 0 6px;font:400 12px/18px -apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;color:#545a66">Or enter this one-time code</p><p class="ink" style="margin:0;font:700 28px/36px ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:5px;color:#16181d">${escapeHtml(message.oneTimeCode)}</p>` : "";
