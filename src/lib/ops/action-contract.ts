...
export const OPS_ACTION_CAPABILITIES: Record<OpsActionName, OpsActionCapabilityDefinition> = {
  ...
  team_suspend: { capability: "available", description: "owner-only CAS suspension with last-owner protection and session revocation" },
  team_reactivate: { capability: "available", description: "owner-only CAS reactivation of a suspended member" },
  ...
  booking_cancel: { capability: "capability_required", description: "Hermes SnagTime action lane requires verified provider readiness" },
  booking_reschedule: { capability: "capability_required", description: "Hermes SnagTime action lane requires verified provider readiness" },
