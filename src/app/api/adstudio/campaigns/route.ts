...
import type { AdStudioBrandKit, AdStudioGoal, AdStudioPlatform } from "@/modules/adstudio";
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const pack = generateAdStudioCampaignPack({
      ...
      platforms: body.platforms ?? ["meta", "google_search", "google_pmax", "google_demand_gen"],
