...
import { summarizePersistedPublishPlan, summarizePersistedPublishSource } from "@/lib/adbuilder/publish-receipt";
import {
  PublishError,
...
} from "@/lib/adbuilder/publish-adapter";
...
/**
 * POST /api/adbuilder/ads/[id]/publish?workspaceId=...
 *
...
export async function POST(request: NextRequest, context: RouteContext) {
  ...
  if (typeof body.resumePlanId === "string" && body.resumePlanId) {
    try {
      ...
      if (saved.adBuilderCampaignId !== id || !saved.controls.activationApproval) {
