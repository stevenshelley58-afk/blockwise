...
import { activateApprovedAdBuilderPlan } from "@/lib/providers/adbuilder-activation";
...
export async function POST(request: NextRequest, context: { params: Promise<{ id: string }> | { id: string } }) {
  ...
  return activateApprovedAdBuilderPlan({ adId: id, workspaceId: access.access.workspaceId,
