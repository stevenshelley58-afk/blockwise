...
import { getTemplate, getTemplateForExistingCustomerAd, templateAssetStoragePath, type GallerySamplePlacement } from "@/lib/adbuilder/pack-gallery";
...
export async function GET(
  ...
  try {
    ...
    console.error("Ad Builder template preview failed", { templateId, placement, error });
