...
import { UPLOAD_REJECTION_MESSAGES, VIDEO_UPLOAD_CHUNK_BYTES } from "@/lib/adbuilder/video-limits";
import { inspectVideoFile } from "@/lib/adbuilder/video-media-inspect";
import { VIDEO_BUCKET, VIDEO_MIME_EXTENSIONS, versionObjectPath, type VideoMime } from "@/lib/adbuilder/video-refs";
import {
  appendChunk,
  discardScratch,
  readHead,
