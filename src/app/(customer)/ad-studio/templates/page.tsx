...
export default async function TemplatesPage({ searchParams }: { searchParams: SearchParams }) {
  ...
  return (
    <div className="mx-auto w-full max-w-[1120px] px-4 pt-6 pb-28 md:px-6 md:pt-8 md:pb-16">
      ...
      {templates.length > 0 ? <p className="mt-8 text-center text-xs text-muted-foreground">All {templates.length} available templates are retained here. Metadata reflects the imported pack.</p> : null}
    </div>
  );
}
