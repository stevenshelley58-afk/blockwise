...
export default async function AssetsPage() {
  ...
  const [assetsPage, adsPage, kits] = await Promise.all([
  ...
  return <MediaLibrary workspaceId={workspaceId} brandKitId={kit ? String(kit.id) : ""} assets={assetsPage.items as LibraryAssetModel[]} ads={adsPage.items as LibraryAdModel[]} nextAssetCursor={assetsPage.nextCursor} nextAdCursor={adsPage.nextCursor} />;
}
