...
const sourceOnlyVersions = [
  { date: "2 June", title: "Utility panel", flow: "Publish · Budget · Schedule", note: "Small embedded panel in Ad Builder.", commit: "d35919eca5" },
...
export default async function PublishHistoryPage() {
  await requirePageSurfaceAccess("adbuilder");
  return <div className="min-h-screen bg-background text-foreground">
    <header className="border-b border-border bg-card px-4 py-4 sm:px-6">
      <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-3">
        ...
        <Button asChild variant="outline"><Link href="/ad-builder/ads">Back to current Ads</Link></Button>
      </div>
    </header>
