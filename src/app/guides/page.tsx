...
const guides = [
  ...
  {
    href: "/guides/meta-ad-library-competitor-research-real-estate",
    image: "/guides/ad-library/hero.webp",
    alt: "A magnifying glass examining a grid of advertisements to find gaps",
    label: "Competitor research",
    title: "Ad Library competitor research",
    hook: "The Meta Ad Library tells you what other agents are saying. The opportunity is finding what they are not saying — and building original ads that fill the gap.",
    readTime: "10 minutes",
