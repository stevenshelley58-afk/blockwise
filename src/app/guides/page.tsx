...
export const metadata: Metadata = {
  ...
  description:
    "Australian real-estate advertising guides built around clear decisions, reliable evidence and campaign steps your team can use.",
      ...
      <main className="bw-guides-index" id="main-content">
        <section className="bw-guides-index-intro">
          ...
          <p className="bw-guides-index-deck">
            Australian campaign guidance grounded in real decisions, reliable evidence and steps your team can review before spending.
          </p>
          <ul className="bw-guides-principles" aria-label="What to expect from Blockwise guides">
            <li><strong>Local</strong><span>Australian market and compliance context</span></li>
        ...
        <section className="bw-guides-method" aria-labelledby="guide-method">
          ...
          <ol>
            ...
            <li><span>02</span><div><h3>Check the evidence</h3><p>Use Australian sources where local context changes the advice.</p></div></li>
