#!/usr/bin/env node
/**
 * AdBuilder Template Readiness Audit
 *
 * Scans every meta-*.json template in src/lib/adbuilder/template-gallery/
 * and produces a machine-readable readiness report.
 *
 * Output:
 *   - .cache/adbuilder-readiness-report.json  (machine-readable)
 *   - stdout summary                         (human-readable)
 *
 * Usage:  node scripts/verify/adbuilder-readiness-audit.mjs
 */
...
// ── Paths ────────────────────────────────────────────────────────────────────
const GALLERY_DIR = join(ROOT, 'src', 'lib', 'adbuilder', 'template-gallery');
const EVIDENCE_DIR = join(GALLERY_DIR, 'evidence');
const CACHE_DIR = join(ROOT, '.cache');
const REPORT_PATH = join(CACHE_DIR, 'adbuilder-readiness-report.json');
...
function main() {
  ...
  console.log('');
  console.log('═══════════════════════════════════════════════════════════');
  console.log('  AdBuilder Template Readiness Audit');
  console.log('═══════════════════════════════════════════════════════════');
  console.log('');
