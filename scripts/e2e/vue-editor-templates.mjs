...
import galleryModule from '../../src/lib/adbuilder/pack-gallery.ts';
import fabricModule from '../../src/components/adbuilder/vue-editor/fabric-scene.ts';
...
const out = process.env.VUE_EDITOR_EVIDENCE_DIR || '/root/work/adbuilder-all-templates-final';
...
const helper = await build({stdin:{contents:`import { hydrateFabricSceneImages } from './src/components/adbuilder/vue-editor/fabric-scene.ts'; window.hydrate=hydrateFabricSceneImages;`,resolveDir:process.cwd()},bundle:true,write:false,format:'iife',platform:'browser',target:'es2020',tsconfig:'tsconfig.json'});
