...
coverage: postgres roles/chatwoot/snagtime, mariadb/mautic, mautic config/media, chatwoot storage; product-mail state is covered by scripts/vps/stalwart-backup.sh
