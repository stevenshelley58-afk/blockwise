...
ROUTE_ID = "blockwise-process-preview"
...
def main():
    ...
    parser.add_argument("--upstream", default="blockwise-process-preview:3000")
    args = parser.parse_args()
    if not re.fullmatch(r"blockwise-process-preview(?:-[a-f0-9]{8,40})?:3000", args.upstream):
    ...
    if not args.remove:
        routes.insert(0, {
            "@id": ROUTE_ID,
            "match": [{"host": ["blockwise.sale"], "path": ["/homepage-preview/process-iteration", "/homepage-preview/process-iteration/*"]}],
