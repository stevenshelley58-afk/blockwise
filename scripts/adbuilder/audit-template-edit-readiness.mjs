...
const galleryDir = resolve(process.env.ADBUILDER_GALLERY_DIR ?? "src/lib/adbuilder/template-gallery");

function usage(message) {
  if (message) process.stderr.write(`${message}\n\n`);
  process.stderr.write("Usage: node scripts/adbuilder/audit-template-edit-readiness.mjs [--template <id[,id...]>] [--output <path>]\n");
