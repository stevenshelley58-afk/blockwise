...
- **Keep customer navigation permanent.** Self-serve customer routes keep the five mobile destinations: Home, Ads, Results, Leads and More. Ads owns the full Ad Builder subtree. Never expose an unavailable tool or invent a destination to fill the menu.
