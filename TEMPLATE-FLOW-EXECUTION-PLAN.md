...
- **Phase 2: P2.1 DONE** (in-place editor with region hit-targets, inline edits, undo). P2.2 in progress. P2.3–P2.5 pending — note P2.3 requires running `scripts/migrations/snapshot-legacy-creatives.mjs` against prod before deleting the renderer.
