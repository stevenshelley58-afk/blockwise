...
They are the visual target for the templates maintained in `mautic/emails.py`.
...
Dark mode rules carried by the Mautic templates: body/background, `.card`, `.detail-card`,
