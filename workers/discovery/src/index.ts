...
const env = {
  ...
  DISCOVERY_BUILD_MODE: process.env.DISCOVERY_BUILD_MODE === "true",
  DISCOVERY_STEADY_INTERVAL_HOURS: parseInt(process.env.DISCOVERY_STEADY_INTERVAL_HOURS ?? "6", 10),
  DISCOVERY_BUILD_GAP_SECONDS: parseInt(process.env.DISCOVERY_BUILD_GAP_SECONDS ?? "30", 10),
