...
select
  ...
  least(oa.first_seen_at, ap.first_seen_at),
  greatest(oa.last_seen_at, ap.last_seen_at)
...
select
  ...
  coalesce(oa.first_seen_at, am.created_at),
  coalesce(oa.last_seen_at, am.created_at)
