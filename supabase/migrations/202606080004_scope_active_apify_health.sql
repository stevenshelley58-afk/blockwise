-- Scope paid-spend health to the active Apify provider.
-- Candidate actor canary failures stay on capture_actors/defects; they should
-- not make the public research worker health red after a different actor passes.
...
active_paid_apify_24h as (
  ...
  where active.source_provider is not null
    and afr.source_provider = active.source_provider
