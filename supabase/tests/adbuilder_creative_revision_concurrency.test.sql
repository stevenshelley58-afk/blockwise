...
delete from public.adbuilder_creative_revision_mutations
where workspace_id = 'd1000000-0000-4000-8000-000000000001';
delete from public.adbuilder_creative_revisions
where workspace_id = 'd1000000-0000-4000-8000-000000000001';
delete from public.adbuilder_creatives
where workspace_id = 'd1000000-0000-4000-8000-000000000001';
delete from public.adbuilder_campaign_variants
where workspace_id = 'd1000000-0000-4000-8000-000000000001';
delete from public.adbuilder_campaigns
where workspace_id = 'd1000000-0000-4000-8000-000000000001';
delete from public.adbuilder_brand_kits
where workspace_id = 'd1000000-0000-4000-8000-000000000001';
...
select extensions.dblink_send_query(
  ...
  $$
    with jwt as materialized (
      ...
      select claim.state
      from jwt
      cross join lateral public.adbuilder_claim_creative_revision_mutation(
        'd1000000-0000-4000-8000-000000000001',
        'd5000000-0000-4000-8000-000000000001',
        (
