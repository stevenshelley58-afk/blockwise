...
select lives_ok($$ select public.enqueue_ops_action(
  ...
  'Customer requested team access', '2026-09-04T00:00:00.000Z', '2026-09-04T01:00:00.000Z',
...
select lives_ok($$ select public.enqueue_ops_action(
  ...
  'Customer updated the invite request', '2026-09-04T00:00:00.000Z', '2026-09-04T01:00:00.000Z',
...
select lives_ok($$ select public.enqueue_ops_action(
  ...
  '87777777-7777-4777-8777-777777777777', 'owner', 'aal2', 1,
  'Role executor is not enabled', '2026-09-04T00:00:00.000Z', '2026-09-04T01:00:00.000Z',
  '{"role":"viewer"}'::jsonb
...
select lives_ok($$ select public.enqueue_ops_action(
  ...
  '87777777-7777-4777-8777-777777777777', 'owner', 'aal2', 1,
  'Suspension capability is not implemented', '2026-09-04T00:00:00.000Z', '2026-09-04T01:00:00.000Z', '{}'::jsonb
...
select throws_ok($$ select public.enqueue_ops_action(
  ...
  'team_invite', 'workspace', '86666666-6666-4666-8666-666666666666',
  '87777777-7777-4777-8777-777777777777', 'owner', 'aal2', 1,
  'unsafe payload test', '2026-09-04T00:00:00.000Z', '2026-09-04T01:00:00.000Z',
...
select throws_ok($$ select public.enqueue_ops_action(
  ...
  'aal test', '2026-09-04T00:00:00.000Z', '2026-09-04T01:00:00.000Z',
  '{"email":"invite@example.test","role":"member"}'::jsonb
...
select throws_ok($$ select public.enqueue_ops_action(
  ...
  'support owner test', '2026-09-04T00:00:00.000Z', '2026-09-04T01:00:00.000Z', '{}'::jsonb
