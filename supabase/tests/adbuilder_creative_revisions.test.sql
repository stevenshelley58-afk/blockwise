...
select has_table('public', 'adbuilder_creative_revisions', 'creative revisions table exists');
select has_table('public', 'adbuilder_creative_revision_mutations', 'creative revision mutation claims exist');
select has_column('public', 'adbuilder_creatives', 'active_revision_id', 'creatives point to an active revision');
select has_column(
  'public',
  'adbuilder_creative_revision_mutations',
  'request_hash',
  'mutation claims bind to a canonical request hash'
);
select col_not_null('public', 'adbuilder_creatives', 'active_revision_id', 'active revision is required');
select has_function(
  'public',
  'adbuilder_append_creative_revision',
  array['uuid', 'uuid', 'uuid', 'jsonb', 'text', 'text', 'uuid', 'text'],
  'the compare-and-swap append function exists'
);
select has_function(
  'public',
  'adbuilder_claim_creative_revision_mutation',
...
insert into public.adbuilder_brand_kits (id, workspace_id, business_name)
values (
...
insert into public.adbuilder_campaign_variants (
  id,
  workspace_id,
  campaign_id,
  angle,
...
insert into public.adbuilder_creatives (
  id,
  workspace_id,
  campaign_id,
  variant_id,
...
select is(
  (
    select state
    from public.adbuilder_claim_creative_revision_mutation(
      'a1000000-0000-4000-8000-000000000001',
      'a5000000-0000-4000-8000-000000000001',
...
select *
from public.adbuilder_append_creative_revision(
  'a1000000-0000-4000-8000-000000000001',
  'a5000000-0000-4000-8000-000000000001',
  (select active_revision_id from revision_test_base),
...
select is(
  (
    select request_hash
    from public.adbuilder_creative_revision_mutations
...
select throws_ok(
  $$
    select * from public.adbuilder_claim_creative_revision_mutation(
      'a1000000-0000-4000-8000-000000000001',
      'a5000000-0000-4000-8000-000000000001',
      (select active_revision_id from revision_test_base),
      'a6000000-0000-4000-8000-000000000001',
  ...
  $$,
  '22023',
  'ADBUILDER_MUTATION_CONTENT_MISMATCH',
...
select throws_ok(
  $$
    select * from public.adbuilder_append_creative_revision(
...
grant select, update, delete on public.adbuilder_creatives to authenticated;
...
select active_revision_id from public.adbuilder_creatives
where workspace_id = 'a1000000-0000-4000-8000-000000000001'
  and id = 'a5000000-0000-4000-8000-000000000001';
select lives_ok(
  $$
...
select isnt(
  (
    select active_revision_id::text from public.adbuilder_creatives
    where workspace_id = 'a1000000-0000-4000-8000-000000000001'
      and id = 'a5000000-0000-4000-8000-000000000001'
  ),
...
select is(
  (
    select count(*)::integer from public.adbuilder_creative_revisions
    where workspace_id = 'a1000000-0000-4000-8000-000000000001'
      and creative_id = 'a5000000-0000-4000-8000-000000000001'
  ),
  3,
...
select lives_ok(
  $$
    select public.adbuilder_release_creative_revision_mutation(
      'a1000000-0000-4000-8000-000000000001',
      'a5000000-0000-4000-8000-000000000001',
      'a6000000-0000-4000-8000-000000000005'
    )
...
select throws_ok(
  $$
    delete from public.adbuilder_creatives
    where workspace_id = 'a1000000-0000-4000-8000-000000000001'
      and id = 'a5000000-0000-4000-8000-000000000001'
  $$,
  '23503',
...
select ok(
  not has_table_privilege('authenticated', 'public.adbuilder_creative_revisions', 'UPDATE'),
  'authenticated users cannot update revision rows directly'
);
select ok(
  not has_table_privilege('authenticated', 'public.adbuilder_creative_revisions', 'DELETE'),
  'authenticated users cannot delete revision rows directly'
);
select ok(
  not has_table_privilege('service_role', 'public.adbuilder_creative_revisions', 'UPDATE'),
  'service role cannot bypass immutable revisions with a direct update'
);
select ok(
  not has_table_privilege('service_role', 'public.adbuilder_creative_revisions', 'DELETE'),
  'service role cannot bypass immutable revisions with a direct delete'
);
select is(
  (select count(*)::integer from public.adbuilder_creatives where active_revision_id is null),
  0,
  'all creatives have an active revision after backfill and inserts'
);
select ok(
  (select relrowsecurity from pg_class where oid = 'public.adbuilder_creative_revisions'::regclass),
