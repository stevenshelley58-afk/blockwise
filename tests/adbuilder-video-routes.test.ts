...
const uploadsRoute = "src/app/api/adbuilder/videos/uploads/route.ts";
const uploadIdRoute = "src/app/api/adbuilder/videos/uploads/[uploadId]/route.ts";
const mediaRoute = "src/app/api/adbuilder/videos/media/route.ts";
const videosRoute = "src/app/api/adbuilder/videos/route.ts";
