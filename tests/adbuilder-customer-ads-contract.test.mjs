...
register();
const { createCustomerAd, loadCustomerAd, CustomerAdNotFoundError } = await import("../src/lib/adbuilder/create-customer-ad.ts");
const { adFormatLabel } = await import("../src/lib/adbuilder/library-contract.ts");
