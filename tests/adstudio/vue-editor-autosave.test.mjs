...
import { createAutosaveController } from "../../src/components/adstudio/vue-editor/autosave-controller.ts";
...
test("native shell uses the autosave controller for dirty edits", () => {
  const source = readFileSync("src/components/adstudio/vue-editor/vue-editor-shell.tsx", "utf8");
