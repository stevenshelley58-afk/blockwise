...
const checkout = "src/app/api/adbuilder/videos/[id]/checkout/route.ts";
const order = "src/app/api/adbuilder/videos/[id]/order/route.ts";
const brief = "src/app/api/adbuilder/videos/[id]/brief/route.ts";
const videos = "src/app/api/adbuilder/videos/route.ts";
...
test("an order can only be created for a commissioned project that is yours", () => {
  const source = read("src/lib/adbuilder/video-order.ts");
