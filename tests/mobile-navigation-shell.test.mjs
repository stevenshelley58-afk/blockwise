...
test("Ad Builder shares the global mobile frame on every route, including the editor", () => {
  ...
  assert.match(mobileNav, /pathname === "\/ad-builder" \|\| pathname\.startsWith\("\/ad-builder\/"/);
});
