...
const envSchema = z.object({
  ...
  HERMES_RESEARCH_STORAGE_URL: z.string().url().optional(),
  HERMES_RESEARCH_STORAGE_SECRET_KEY: z.string().min(1).optional(),
  HERMES_RESEARCH_STORAGE_SERVICE_ROLE_KEY: z.string().min(1).optional(),
